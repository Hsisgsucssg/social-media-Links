...
test.describe('Performance and Core Web Vitals Testing', () => {
  test.describe('Lighthouse Performance Testing', () => {
    ...
    test('should meet performance benchmarks on desktop', async ({ page }) => {
      ...
      // Performance scores should meet targets
      ...
      expect(tbt).toBeLessThan(200);   // Total Blocking Time < 200ms
      expect(si).toBeLessThan(3400);   // Speed Index < 3.4s
    });
    ...
    test('should meet performance benchmarks on mobile', async ({ page }) => {
      ...
      expect(performanceScore).toBeGreaterThanOrEqual(85); // Slightly lower threshold for mobile
      ...
      expect(fcp).toBeLessThan(3000); // More lenient for mobile
